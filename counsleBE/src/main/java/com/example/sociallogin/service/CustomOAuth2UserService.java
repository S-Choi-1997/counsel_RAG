...
import com.example.sociallogin.security.OAuth2UserInfo;
import com.example.sociallogin.security.OAuth2UserInfoFactory;
    ...
    private OAuth2User processOAuth2User(OAuth2UserRequest oAuth2UserRequest, OAuth2User oAuth2User) {
        ...
        if (userOptional.isPresent()) {
            ...
            if (!registrationId.equals(user.getProvider())) {
                throw new OAuth2AuthenticationException("You are signed up with " + user.getProvider() + " account. Please use your " + user.getProvider() + " account to login.");
            }
